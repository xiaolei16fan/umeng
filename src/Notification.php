...
use UmengPush\Android\AndroidCustomizedcast;
use UmengPush\Android\AndroidFilecast;
use UmengPush\Android\AndroidGroupcast;
use UmengPush\Android\AndroidUnicast;
use UmengPush\Ios\IOSBroadcast;
use UmengPush\Ios\IOSCustomizedcast;
use UmengPush\Ios\IOSFilecast;
...
class Notification
{
    ...
    public function sendAndroidUnicast()
    {
        try {
            ...
            $unicast->setPredefinedKeyValue("device_tokens", "AmssoqKwtkd21SYmt-2qgkjnYMneoRtufiael2_jKGev");
    ...
    public function sendIOSUnicast()
    {
        try {
            ...
            $unicast->setPredefinedKeyValue("timestamp", $this->timestamp);
            // Set your device tokens here
            $unicast->setPredefinedKeyValue("device_tokens", "66d05b4f4b8fcdce9a0e8068bf88a1f6d10358c70e151cae01c23d3accbfc9b5");
